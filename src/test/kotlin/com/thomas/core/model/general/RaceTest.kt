...
import com.thomas.core.model.general.Race.BLACK
import com.thomas.core.model.general.Race.BROWN
import com.thomas.core.model.general.Race.INDIGENOUS
import com.thomas.core.model.general.Race.WHITE
import com.thomas.core.model.general.Race.YELLOW
...
class RaceTest {
    ...
    fun `Race PT_BR`() {
        ...
        assertEquals(
            ...
            WHITE.typeDescription
        )
        assertEquals("Preta", BLACK.typeName)
        assertEquals(
            "Pessoas que se identificam com as características físicas e culturais associadas às populações africanas.",
            BLACK.typeDescription
        )
        assertEquals("Amarela", YELLOW.typeName)
        assertEquals(
            "Pessoas que se identificam com as características físicas e culturais associadas às populações asiáticas.",
            YELLOW.typeDescription
        )
        assertEquals("Parda", BROWN.typeName)
        assertEquals(
            "Pessoas que se identificam com a miscigenação de diferentes raças, especialmente a mistura entre africanos e europeus.",
            BROWN.typeDescription
        )
    ...
    fun `Race EN_US`() {
        ...
        assertEquals(
            "People who identify with the miscegenation of different races, especially the mixture between Africans and Europeans.",
            BROWN.typeDescription
        )
